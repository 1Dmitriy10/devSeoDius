...
let stepsTabs = new Tabs({ class: "steps-subtitle" })
let whatIsSEOauditTabs = new Tabs({ class: "what-is-SEOaudit__tab" })
let needDiagnosticstTabs = new Tabs({ class: "need-diagnostics" })
